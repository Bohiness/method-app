...
with_node \
  ...
  --target "/Users/bohiness/Documents/method-app/ios/Pods/Target Support Files/Pods-Methoddo/ExpoModulesProvider.swift" \
  --entitlement "/Users/bohiness/Documents/method-app/ios/Methoddo/Methoddo.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-audio" "expo-av" "expo-blur" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-random" "expo-router" "expo-splash-screen" "expo-store-review" "expo-symbols" "expo-system-ui" "expo-updates" "expo-web-browser"
