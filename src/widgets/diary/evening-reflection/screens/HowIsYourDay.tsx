        ...
        <View className="flex-1 justify-center items-center p-4" variant='default'>
            ...
            <View className="justify-center -mt-10 px-4">
                <Title weight='medium' className="mb-2 text-center">
                    {t('diary.eveningreflection.howisyourday.title')}
                </Title>
                <Text variant='secondary' className="mb-8 text-center">
                    {t('diary.eveningreflection.howisyourday.subtitle')}
                </Text>
            </View>
            ...
            <View className="flex-row justify-between px-4 mb-6">
                <Title className="mt-4 text-center">
                    <Animated.Text layout={Layout.springify()}>
                        {t(`diary.eveningreflection.howisyourday.quality.${currentRange.value}`)}
                    </Animated.Text>
                </Title>
            </View>
            ...
            <View className="w-full">
                <Slider
                    ...
                    ranges={sleepRanges}
                    leftLabel={t('diary.eveningreflection.howisyourday.start')}
                    rightLabel={t('diary.eveningreflection.howisyourday.end')}
                />
            </View>
        </View>
    )
