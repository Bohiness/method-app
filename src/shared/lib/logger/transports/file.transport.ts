...
export class FileTransport extends BaseTransport {
  ...
  private async initialize(): Promise<void> {
    try {
      ...
      console.log('FileTransport initialized:', {
        dirPath,
  ...
  async write(data: LogData): Promise<void> {
    try {
      ...
      console.log('FileTransport write debug:', {
      ...
      console.log('FileTransport write success, current content:', content);
  ...
  async getStats(): Promise<{
    ...
    try {
      ...
      const content = fileInfo.exists ? 
        await FileSystem.readAsStringAsync(this.currentLogFile) : 
        '';
